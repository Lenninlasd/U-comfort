...
const optionsWall = TABLA_U_TECHO_PARED_PARTICION.filter(element => (
    ...
    <option key={el.material} value={el.material}>{el.material}</option>
);
    ...
    return (
        <div className='form-group list-of-elements'>
            <div className='form-row'>
                <div className='col'>
                    <small><strong>{cardinalPoints[pared.orientacion]}:</strong></small>
                    <SelectWinProps
                        tag={keyForm}
...
const ConfigWalls = ({paredes, handleBackButton, handleChange}) => {
    return (
        <div>
            ...
            <small><strong>PROPIEDADES DE LOS MUROS:</strong></small>
